...
skyGeo.scale(-1, 1, 1);
const skyTex = new THREE.TextureLoader().load("img/chichen-itza-blur.png");
const skyMat = new THREE.MeshBasicMaterial({ map: skyTex });
const sky = new THREE.Mesh(skyGeo, skyMat);
sky.rotation.y = Math.PI / 0.55; // giro del fondo
sky.rotation.z = Math.PI / -0.1; // giro del fondo
scene.add(sky);
...
gltfLoader.load("modelos/chichen-itza.glb",
  (gltf) => {
